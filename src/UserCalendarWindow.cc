/*
 * File name: UserCalendarWindow.cc
...
UserCalendarWindow::UserCalendarWindow(CoursesManager &cManager, UserStats &uStats, QWidget *parent) :
    QDialog(parent), ui_(new Ui::UserCalendarWindow), coursesManager_(&cManager), userStats_(&uStats)
{
    ui_->setupUi(this);
...
bool UserCalendarWindow::isEqualToCurrentDate(QDate date) const {
...
bool UserCalendarWindow::areDatesEqual(QDate date1, QDate date2) const {
